...
export const MPP_SCHEMA = {
  ...
  method: "GET",
  description: "Purchase widget tokens. Returns a JSON array of widget objects.",
  params: {
    quantity: {
      type: "integer",
      default: 1,
  ...
  example_requests: [
    {
      ...
      command: `tempo request "${siteUrl}/api/mpp/widgets"`,
    },
    {
      description: "Buy 3 widgets",
      command: `tempo request "${siteUrl}/api/mpp/widgets?quantity=3"`,
    },
  ],
  discovery: {
